...
public class MockConstants {
    ...
    public static final String DOORS_OUT_FILE_PATH = "src\\test\\resources\\doorsWithId.json";
    ...
    public static final String HOUSES_OUT_FILE_PATH = "src\\test\\resources\\housesWithId.json";
